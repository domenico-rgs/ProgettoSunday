...
phi_E=[ones(n,1) x1_id x2_id x1_id.^2 x2_id.^2 x1_id.*x2_id x1_id.^3 x2_id.^3 (x1_id.^2).*x2_id x1_id.*(x2_id.^2)...
    x1_id.^4 x2_id.^4 (x1_id.^3).*x2_id x1_id.*(x2_id.^3) (x1_id.^2).*(x2_id.^2)...
     x1_id.^5 x2_id.^5 (x1_id.^4).*x2_id x1_id.*(x2_id.^4) (x1_id.^3).*(x2_id.^2) (x1_id.^2).*(x2_id.^3)...
     x1_id.^6 x2_id.^6 x1_id.^5.*x2_id x1_id.*x2_id.^5 (x1_id.^2).*(x2_id.^4) (x1_id.^4).*(x2_id.^2) (x1_id.^3).*(x2_id.^3)];
phi_E_ext = [ones(length(X1(:)),1) X1(:) X2(:) X1(:).^2 X2(:).^2 X1(:).*X2(:) X1(:).^3 X2(:).^3 (X1(:).^2).*X2(:) X1(:).*(X2(:).^2) X1(:).^4 X2(:).^4 ...
    (X1(:).^2).*(X2(:).^2) (X1(:).^3).*X2(:) X1(:).*(X2(:).^3) X1(:).^5 X2(:).^5 (X1(:).^4).*X2(:) X1(:).*(X2(:).^4) (X1(:).^3).*(X2(:).^2) (X1(:).^2).*(X2(:).^3)...
    X1(:).^6 X2(:).^6 (X1(:).^5).*X2(:) (X1(:)).*(X2(:).^5) (X1(:).^2).*(X2(:).^4) (X1(:).^4).*(X2(:).^2) (X1(:).^3).*(X2(:).^3)];
...
phi_E_Val=[ones(n,1) x1_val x2_val x1_val.^2 x2_val.^2 x1_val.*x2_val x1_val.^3 x2_val.^3 (x1_val.^2).*x2_val x1_val.*(x2_val.^2)...
    x1_val.^4 x2_val.^4 (x1_val.^3).*x2_val x1_val.*(x2_val.^3) (x1_val.^2).*(x2_val.^2)...
     x1_val.^5 x2_val.^5 (x1_val.^4).*x2_val x1_val.*(x2_val.^4) (x1_val.^3).*(x2_val.^2) (x1_val.^2).*(x2_val.^3)...
     x1_val.^6 x2_val.^6 x1_val.^5.*x2_val x1_val.*x2_val.^5 (x1_val.^2).*(x2_val.^4) (x1_val.^4).*(x2_val.^2) (x1_val.^3).*(x2_val.^3)];
