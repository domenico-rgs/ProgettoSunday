...
stampaModello('Modello SF - 1 armoniche',X1,X2,y_hat_B_ext_mat+p, x1_id, x2_id, y_id_dt+p)
...
% Plot Dati + stima (terzo grado)
stampaModello('Modello SF - 2 armoniche',X1,X2,y_hat_C_ext_mat+p, x1_id, x2_id, y_id_dt+p)
...
% Plot Dati + stima (terzo grado)
stampaModello('Modello SF - 3 armoniche',X1,X2,y_hat_D_ext_mat+p, x1_id, x2_id, y_id_dt+p)
