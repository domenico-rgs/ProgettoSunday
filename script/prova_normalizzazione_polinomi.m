...
%% Modello polinomiale di quindicesimo grado
phi_20=[ones(n,1) x1_id x2_id x1_id.^2 x2_id.^2 x1_id.*x2_id x1_id.^3 x2_id.^3 (x1_id.^2).*x2_id x1_id.*(x2_id.^2) x1_id.^4 x2_id.^4 (x1_id.^2).*(x2_id.^2) (x1_id.^3).*x2_id x1_id.*(x2_id.^3) ...
     x1_id.^5 x2_id.^5 (x1_id.^4).*x2_id x1_id.*(x2_id.^4) (x1_id.^3).*(x2_id.^2) (x1_id.^2).*(x2_id.^3)...
     x1_id.^6 x2_id.^6 x1_id.^5.*x2_id x1_id.*(x2_id.^5) (x1_id.^4).*(x2_id.^2) (x1_id.^2).*(x2_id.^4) (x1_id.^3).*(x2_id.^3) x1_id.^7 x2_id.^7 x1_id.^6.*x2_id x1_id.*(x2_id.^6) (x1_id.^5).*(x2_id.^2) ...
     (x1_id.^2).*(x2_id.^5) (x1_id.^4).*(x2_id.^3) (x1_id.^3).*(x2_id.^4) x1_id.^8 x2_id.^8 x1_id.^7.*x2_id x1_id.*(x2_id.^7) (x1_id.^6).*(x2_id.^2) ...
     (x1_id.^2).*(x2_id.^6) (x1_id.^5).*(x2_id.^3) (x1_id.^3).*(x2_id.^5) (x1_id.^4).*(x2_id.^4) x1_id.^9 x2_id.^9 x1_id.^8.*x2_id x1_id.*(x2_id.^8) (x1_id.^7).*(x2_id.^2) ...
     ...
     (x1_id.^2).*(x2_id.^10) (x1_id.^9).*(x2_id.^3) (x1_id.^3).*(x2_id.^9) (x1_id.^8).*(x2_id.^4) (x1_id.^4).*(x2_id.^8) (x1_id.^7).*(x2_id.^5) (x1_id.^5).*(x2_id.^7) (x1_id.^6).*(x2_id.^6) x1_id.^13 x2_id.^13 x1_id.^12.*x2_id x1_id.*(x2_id.^12) (x1_id.^11).*(x2_id.^2) ...
     (x1_id.^2).*(x2_id.^11) (x1_id.^10).*(x2_id.^3) (x1_id.^3).*(x2_id.^10) (x1_id.^9).*(x2_id.^4) (x1_id.^4).*(x2_id.^9) (x1_id.^8).*(x2_id.^5) (x1_id.^5).*(x2_id.^8) (x1_id.^7).*(x2_id.^6) (x1_id.^6).*(x2_id.^7)...
     x1_id.^14 x2_id.^14 x1_id.^13.*x2_id x1_id.*(x2_id.^13) (x1_id.^12).*(x2_id.^2) (x1_id.^2).*(x2_id.^12) (x1_id.^11).*(x2_id.^3) (x1_id.^3).*(x2_id.^11) (x1_id.^10).*(x2_id.^4) (x1_id.^4).*(x2_id.^10) (x1_id.^9).*(x2_id.^5) (x1_id.^5).*(x2_id.^9) (x1_id.^8).*(x2_id.^6) (x1_id.^6).*(x2_id.^8) (x1_id.^7).*(x2_id.^7)...
     x1_id.^15 x2_id.^15 x1_id.^14.*x2_id x1_id.*(x2_id.^14) (x1_id.^13).*(x2_id.^2) (x1_id.^2).*(x2_id.^13) (x1_id.^12).*(x2_id.^3) (x1_id.^3).*(x2_id.^12) (x1_id.^11).*(x2_id.^4) (x1_id.^4).*(x2_id.^11) (x1_id.^10).*(x2_id.^5) (x1_id.^5).*(x2_id.^10) (x1_id.^9).*(x2_id.^6) (x1_id.^6).*(x2_id.^9) (x1_id.^8).*(x2_id.^7) (x1_id.^7).*(x2_id.^8)... 
%      x1_id.^16 x2_id.^16 x1_id.^15.*x2_id x1_id.*(x2_id.^15) (x1_id.^14).*(x2_id.^2) (x1_id.^2).*(x2_id.^14) (x1_id.^13).*(x2_id.^3) (x1_id.^3).*(x2_id.^13) (x1_id.^12).*(x2_id.^4) (x1_id.^4).*(x2_id.^12) (x1_id.^11).*(x2_id.^5) (x1_id.^5).*(x2_id.^11) (x1_id.^10).*(x2_id.^6) (x1_id.^6).*(x2_id.^10) (x1_id.^9).*(x2_id.^7) (x1_id.^7).*(x2_id.^9) (x1_id.^8).*(x2_id.^8)...  
     ];
 
[theta_20, std_theta_20] = lscov(phi_20, y_id_dt);
q_20 = length(theta_20);
y_hat_20 = phi_20 * theta_20;
epsilon_20 = y_id_dt - y_hat_20; %residuo
SSR_20 = epsilon_20'*epsilon_20;

[FPE20,AIC20,MDL20] = TestOggettivi(n, q_20, SSR_20);
