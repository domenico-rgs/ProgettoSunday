...
stampaModello('Modello 1 armoniche',X1,X2,y_hat_B_ext_mat+m, x1_id, x2_id, (y_id+trend_1))
...
% Plot Dati + stima (terzo grado)
stampaModello('Modello 2 armoniche',X1,X2,y_hat_C_ext_mat+m, x1_id, x2_id, (y_id+trend_1))
...
% Plot Dati + stima (terzo grado)
stampaModello('Modello 3 armoniche',X1,X2,y_hat_D_ext_mat+m, x1_id, x2_id, (y_id+trend_1))
...
% Plot Dati + stima (terzo grado)
stampaModello('Modello 4 armoniche',X1,X2,y_hat_E_ext_mat+m, x1_id, x2_id, (y_id+trend_1))
